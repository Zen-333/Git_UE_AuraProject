...
public:
	...
	bool IsSuccessfulDebuff() const { return bIsSuccessDebuff; }
	...
	void SetIsSuccessfulDebuff(bool bInIsDebuff) { bIsSuccessDebuff = bInIsDebuff; }
	...
	virtual bool NetSerialize(FArchive& Ar, class UPackageMap* Map, bool& bOutSuccess); // Research
