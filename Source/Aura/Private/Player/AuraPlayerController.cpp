...
void AAuraPlayerController::BeginPlay()
{
	...
	if (Subsystem) 
	{
		Subsystem->AddMappingContext(AuraContext, 0); // 0 is for the priority
	}
...
void AAuraPlayerController::ShowDamageNumber_Implementation(float DamageAmount, ACharacter* TargetCharacter, bool bBlockedHit, bool bCriticalHit)
{
	...
	if(IsValid(TargetCharacter) && DamageTextComponentClass && IsLocalController()) // Is Valid checks if pointer is pending Kill e.g destroy was called
	{
...
void AAuraPlayerController::CursorTrace()
{
	...
	if(GetASC() && GetASC()->HasMatchingGameplayTag(FAuraGameplayTags::Get().Player_Block_CursorTarce))
	{
